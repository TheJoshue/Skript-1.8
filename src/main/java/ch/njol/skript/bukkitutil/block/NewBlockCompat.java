...
public class NewBlockCompat implements BlockCompat {
	...
	static class NewBlockValues extends BlockValues {
		...
		// Skript-1.8 - Make package-private for MagicBlockCompat
		NewBlockValues(Material type, BlockData data, boolean isDefault) {
